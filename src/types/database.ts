  ...
  public: {
    Tables: {
      ...
      player_accusations: {
        ...
        Relationships: [
          {
            foreignKeyName: "player_accusations_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "player_accusations_puzzle_id_fkey"
            columns: ["puzzle_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      submit_murdle_accusation: {
        Args: { p_accusation: string; p_puzzle_id: string }
        Returns: boolean
      }
    }
    Enums: {
